...
--             arrow(beautiful.bg_focus, beautiful.bg_systray),
--             wibox.container.background(mykeyboardlayout, beautiful.bg_systray),
--             arrow(beautiful.bg_systray, "#A77AC4"),
--             wibox.container.background(volume_widget({widget_type = "arc"}), "#A77AC4"),
--             arrow("#A77AC4" ,beautiful.bg_systray),
--             wibox.widget.systray(),
--             arrow(beautiful.bg_systray, "#A77AC4"),
--             wibox.container.background(mytextclock, "#A77AC4"),
--             s.mylayoutbox,
--         },
--     }
-- end)
...
globalkeys = gears.table.join(
    ...
    awful.key({ "Control" }, "space",    
        function ()
            awful.spawn("rofi -show combi -combi-modi 'drun#run#window' -mode 'combi#drun#run' -theme glass/simonvic")
        end,
        {description = "run rofi", group = "launcher"}),

    awful.key({ modkey }, "c",    
        function ()
            awful.spawn("rofi -show calc -mode calc -theme glass/simonvic_calc -no-show-match -no-sort -calc-command \"echo -n '{result}' | xclip -selection clipboard -i\"")
        end,
        {description = "run rofi calc", group = "launcher"}),

    awful.key({ modkey, "Shift" }, "f",    
        function ()
            awful.spawn("rofi -show 'file-browser' -theme glass/simonvic_fileBrowser")
        end,
...
awful.rules.rules = {
    ...
    -- Set Output to go to tag name "4"
    { rule = { instance = "crx_faolnafnngnfdaknnbpnkhgohbobgegn" },
      properties = { screen = 1, tag = "4" } },
    -- Set Emacs to always map on the tag named "3" on screen 1.
    { rule = { class = "Emacs", name ~= "emacs-capture" },
...
-- awful.spawn.with_shell("$HOME/.screenlayout/defaults.sh")
